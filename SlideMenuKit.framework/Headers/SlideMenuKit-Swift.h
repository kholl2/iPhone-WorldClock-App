...
SWIFT_CLASS("_TtC12SlideMenuKit20MasterViewController")
@interface MasterViewController : UIViewController
@property (nonatomic, strong) UIColor * __nonnull menuButtonTintColor;
@property (nonatomic, readonly, strong) UIViewController * __null_unspecified currentController;
@property (nonatomic, readonly, strong) id __nullable menuButton;
...
- (void)closeMenu:(void (^ __nullable)(void))complete;
- (void)addChildViewController:(UIViewController * __nonnull)childController;
...
SWIFT_CLASS("_TtC12SlideMenuKit18MenuViewController")
@interface MenuViewController : UIViewController <UIScrollViewDelegate, UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, readonly, strong) UIView * __null_unspecified parentView;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
